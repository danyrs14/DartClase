...
mixin Afiliado {
  void mostrarAfiliacion() {
    print('El usuario esta afiliado aca');
  }
}
...
class Usuario extends Persona with Afiliado, Estudiante {
...
void main() {
  ...
  final usuario1 = Usuario('Dani', 22, 'danyrs14', apodo: 'Dani Rodsan')
    ...
    ..mostrarAfiliacion() //es un mixin y sin necesidad de intanciar podemos llamar a sus metodos en la clase
    ..estudiar();
